...
<div class="container">
	<div class="row">
		...
		<form action="{{route('detailed-receivings-show')}}" id="item_form" enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
			...
			<div class="form-group form-group-sm">
				<label for="reports_stock_location_label" class="required control-label col-xs-2">Employees</label>			
