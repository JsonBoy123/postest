                  ...
                  <table id="table" class="table table-hover table-striped">
                     <thead id="table-sticky-header">
                        <tr>
                           <th class="" style="" data-field="first_name">
                              <div class="th-inner sortable both">Transaction Id</div>
                           ...
                           <th class="" style="" data-field="first_name">
                              <div class="th-inner sortable both">Remark</div>
                              <div class="fht-cell"></div>
                           </th>
                     ...
                     <tbody>
                        @if(!empty($due_history))
                           @foreach($due_history as $history)
                              <tr data-index="1" data-uniqueid="{{ $history->id }}">
                                 <td class="" style="">{{ $history->id }}</td>
                                 <td class="" style="">{{ $history->payment_type }}</td>
                                 <td class="" style="">{{ $history->remark }}</td>
                                 <td class="" style="">RS. {{ $history->paid_amount }}</td>
