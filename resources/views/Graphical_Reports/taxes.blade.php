...
<div class="container">
	<div class="row">
		...
		<div id="page_title">Tax Graph Report Input</div>

		<form action="{{route('taxGraphReportShow')}}"  enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
			@csrf
