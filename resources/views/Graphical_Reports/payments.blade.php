...
<div class="container">
	<div class="row">
		...
		<div id="page_title">Payment Graphic Report Input</div>

		<form action="{{route('PaymentGraphReportShow')}}"  enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
			@csrf
