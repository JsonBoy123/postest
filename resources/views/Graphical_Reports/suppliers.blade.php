...
<div class="container">
	<div class="row">
		...
		<div id="page_title">Supplier Graph Report Input</div>

		<form action="{{route('supplier-graph.show')}}"  enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
			@csrf
