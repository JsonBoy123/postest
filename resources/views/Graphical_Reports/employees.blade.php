...
<div class="container">
	<div class="row">
		...
		<div id="page_title">Employee Graph Report Input</div>

		<form action="{{route('employee-graph.show')}}"  enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
			@csrf
