...
<div class="container">
	<div class="row">
		...
		<div id="page_title">Categories Graph Report Input</div>

		<form action="{{route('category-graph.show')}}"  enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
			@csrf
