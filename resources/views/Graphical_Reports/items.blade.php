...
<div class="container">
	<div class="row">
		...
		<div id="page_title">Item Graph Report Input</div>
		<form action="{{route('ItemGraphReportShow')}}"  enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
			@csrf
