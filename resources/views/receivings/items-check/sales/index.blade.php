...
<div class="container">
	<div class="row">
		<div class="col-6">
			<div id="page_title"><b>Sales Check</b></div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-2" style="float: right">
			<a href="{{route('receivings-check.index')}}" class="btn btn-primary"><b>Receivings Check </b></a>
		</div>
		<div class="col-md-1" style="float: right" >
	    	<a href="{{route('sales-check.history')}}" class="btn btn-primary"><b>
	          ...
	          <table class="table table-striped table-hover" id="SaleCheckTable">
				...
				@foreach($sales as $sale)
	              <tr class="text-center">
                    ...
                    <th>{{$sale->comment}}</th>
	                <td><a href="{{route('sales-check.show', $sale->id)}}"><span title="Show Items" class="glyphicon glyphicon-list-alt"></span></a></td>
	              </tr>
	            @endforeach
	            </tbody>
	          </table>
