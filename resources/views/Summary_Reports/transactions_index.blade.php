...
<div class="container">
	<div class="row">
		...
		<div id="page_title">Transaction Report Input</div>

		<form action="{{route('Showtransactions')}}" id="item_form" enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
			...
			<div class="form-group form-group-sm">
				...
				<div id="report_sale_type" class="col-xs-3">
					...
					<option value="1">Completed Sales and Returns</option>
