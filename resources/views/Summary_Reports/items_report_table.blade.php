...
<div class="container">
	<div class="row">
		...
		<div id="page_title">Report Inputs</div>

		<form action="{{route('show_items_report')}}" id="item_form" enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
			@csrf()
