...
<div class="container">
	<div class="row">
		...
		<div id="page_title">Suppliers Report Input</div>

		<form action="{{route('suppliers-report.show')}}" id="item_form" enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
			@csrf()
