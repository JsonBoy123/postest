...
<div class="container">
	<div class="row">
		...
		<div id="page_title">Expenses Report Input</div>

		<form action="{{route('expanses-report.show')}}" id="item_form" enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
			@csrf()
			...
			<button name="generate_report" class="btn btn-primary btn-sm">Submit</button>
		</form>
	</div>
</div>
<script>
