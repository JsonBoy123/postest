...
<div class="container">
	<div class="row">
		...
		<div id="page_title">Items Report Input</div>

		<form action="{{route('items-report.show')}}" id="item_form" enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
