...
<div class="container">
	<div class="row">
		<div id="page_title">Payments Report Input</div>

		<form action="{{route('payments-report.show')}}" id="item_form" enctype="multipart/form-data" class="form-horizontal" method="post" accept-charset="utf-8">
			@csrf()
